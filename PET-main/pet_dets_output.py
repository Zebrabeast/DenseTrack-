...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='best_checkpoint.pth', help='resume from checkpoint')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_root', type=str, default='/home/data_SSD/zk/pet_outputs/test_data', 
